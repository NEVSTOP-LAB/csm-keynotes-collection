...
> - pdf: [可通讯状态机(CSM)架构框架优势实例分析.pdf](./从问题到实现——CSM在典型场景中的落地实践@北京LV爱好者聚会/从问题到实现——CSM在典型场景中的落地实践.pdf)
> - gif: [工程范例展示——范例-1.gif](./可通讯状态机(CSM)架构框架优势实例分析@wibinar/现场工程范例展示/工程范例展示——范例-1.gif)
> - gif: [工程范例展示——范例-1.gif](./可通讯状态机(CSM)架构框架优势实例分析@wibinar/现场工程范例展示/工程范例展示——范例-2.gif)
> - gif: [工程范例展示——范例-1.gif](./可通讯状态机(CSM)架构框架优势实例分析@wibinar/现场工程范例展示/工程范例展示——范例-3.gif)